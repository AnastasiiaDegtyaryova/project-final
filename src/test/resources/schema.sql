-- =========================
-- H2 test schema (no Liquibase runtime needed)
-- Ідемпотентний rebuild
-- =========================

SET MODE PostgreSQL;

-- Прибираємо все, якщо було
...
CREATE TABLE project (
    ...
    parent_id  BIGINT,
    -- дефолт, щоб інсерти без поля не падали
...
-- Liquibase службові (не обов'язково, але хай будуть порожні)
